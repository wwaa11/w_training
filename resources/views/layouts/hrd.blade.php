...
<body class="prompt">
    <nav class="navbar">
        ...
        <div class="navbar-links hidden lg:flex">
            ...
            <a class="{{ request()->routeIs("hrd.index") ? "active" : "" }}" href="{{ route("hrd.index") }}">
                <i class="fa-solid fa-list mr-2"></i>รายการที่เปิดลงทะเบียน
            </a>
            <a class="{{ request()->routeIs("hrd.history") ? "active" : "" }}" href="{{ route("hrd.history") }}">
                <i class="fa-solid fa-history mr-2"></i>ประวัติการเข้าร่วม
            </a>
            <a class="{{ request()->routeIs("hrd.user-guide") ? "active" : "" }}" href="{{ route("hrd.user-guide") }}">
                <i class="fa-solid fa-book mr-2"></i>คู่มือการใช้งาน
            </a>
            @if (auth()->user()->role == "sa" || auth()->user()->role == "hr")
                <a class="{{ request()->routeIs("hrd.admin.*") ? "active" : "" }}" href="{{ route("hrd.admin.index") }}">
                    <i class="fa-solid fa-cog mr-2"></i>Admin Panel
                </a>
            @endif
        </div>
