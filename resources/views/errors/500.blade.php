...
@section("content")
    <div class="flex h-screen flex-col text-gray-600">
        <div class="m-auto flex w-full flex-col rounded-lg bg-[#fff] py-6 text-center text-lg shadow md:w-1/2 lg:w-2/3">
            <div class="mb-4 text-4xl font-bold text-red-600">500</div>
            <div class="mb-2 text-2xl font-semibold">Internal Server Error</div>
            <div class="mb-4 text-gray-600">ขออภัย เกิดข้อผิดพลาดภายในเซิร์ฟเวอร์</div>
            ...
            <div class="mx-4 mb-4 rounded-lg bg-red-50 p-4">
                <div class="mb-2 text-sm text-red-800">
                    <strong>⚠️ Critical Error</strong>
                </div>
                <div class="text-xs text-red-700">
                    กรุณาติดต่อโปรแกรมเมอร์ทันที<br>
