...
class NurseType1Export implements FromView, WithDrawings
{
    ...
    public function drawings()
    {
        ...
        foreach ($transactions as $index => $transaction) {
            if ($transaction->userData->sign !== null) {
                ...
                $drawing->setHeight(15);
                $drawing->setWidth(120);
                $drawing->setCoordinates('J' . ($index + 5));
                $drawings[] = $drawing;
            }
        }
        return $drawings;
    ...
    public function view(): view
    {
        ...
        return view('nurse.admin.export.type_1')->with(compact('project', 'transactions'));
    }
